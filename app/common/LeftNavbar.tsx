  ...
  return (
    <>
        ...
        <div className="flex h-full flex-col">
          ...
          <Link href="/" className="mb-8 flex items-center gap-3 px-2">
            <img
              src="/favicon.ico"
              alt="PlayVibe Logo"
              className="ml-0.5 h-12 w-12 object-contain"
            />
      ...
      <nav
        ...
        "
      >
        <div className="scrollbar-hide overflow-x-auto overflow-y-hidden px-3 py-2">
            ...
            {MAIN_ITEMS.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={`
                    flex min-w-[64px] shrink-0 items-center justify-center rounded-2xl px-4 py-3 transition
                    ${active ? "bg-white/10" : "hover:bg-white/5"}
                  `}
                  aria-label={item.label}
                  title={item.label}
