...
const MediaCarouselSection = ({
  ...
  return (
    <>
      <section id={sectionId} className="flex flex-col gap-8 py-10 md:gap-10">
        <header className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <SectionHeading
            title={content.title}
            description={content.description}
        ...
        <div className="scrollbar-hide overflow-x-auto overflow-y-hidden md:hidden">
